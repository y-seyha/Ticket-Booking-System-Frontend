...
const OccupancyCharts = dynamic(() => import('@/features/analytics/components/OccupancyCharts').then(m => ({ default: m.OccupancyCharts })), { ssr: false });
...
export default function OccupancyReportPage() {
  ...
  return (
    <div className="space-y-6 px-6 py-8 sm:px-8 sm:py-10 max-w-7xl mx-auto min-h-screen">
      ...
      <OccupancyCharts data={occupancy.data} loading={occupancy.loading} />
